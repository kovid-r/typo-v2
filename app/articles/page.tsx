      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row">
          <main className="flex-1 md:pr-8">
            <h1 className="text-2xl font-medium mb-6"># Articles</h1>
              ...
              {posts.length > 0 ? (
                posts.map((post) => (
                  <li key={post.slug}>
                    <Link href={`/posts/${post.slug}`} className="block">
                      <h2 className="text-lg font-medium text-gray-800 hover:text-gray-600">{post.title}</h2>
                ...
                <li className="text-center py-10">
                  <p className="text-gray-600">
                    No posts found. Add some Markdown files to the content/posts directory.
                  </p>
                </li>
              )}
            </ul>
